export default {
  ...
  tutoriais: 'Tutoriais relacionados',
  idioma: 'Idioma',
  nomeProjeto: 'PROJETO SMARTSILO',
  subtitulo: `instrumentação e controle inteligente aeração / secagem <br /> em silos de armazenamento de grãos`,
  textoSobre: `O SmartSilo é um projeto de pesquisa universitário da Universidade Federal
  ...
  centro: 'Centro: ',
  nomeCentro: 'Escola Agrícola de Jundiaí',
  discente: 'Discente: ',
